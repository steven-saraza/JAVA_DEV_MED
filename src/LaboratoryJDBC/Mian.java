...
import LaboratoryJDBC.Services.AccountServiceMethod;
import LaboratoryJDBC.Services.AccountServices;
import LaboratoryJDBC.Services.CustomerServiceMethod;
import LaboratoryJDBC.Services.CustomerServices;
...
public class Mian {
               ...
               System.out.println("6: Salir al menú anterior");
                ...
                switch (optionAccount){
                    ...
                    case 2:
                        ...
                        System.out.println("Función temporalmente fuera de servicio");
                        break;
                    case 3:
        ...
        public static void addAccount(Scanner scanner){
            ...
            if(client!=null){
                ...
                if (accountServices.addAccount(account, client.getId(),typeAccount, interestRateMonthOrCommision)){
